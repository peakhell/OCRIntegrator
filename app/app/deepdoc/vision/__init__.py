...
def init_in_out(args):
    ...
    import os
    import traceback
    from app.utils.file_utils import traversal_files
    images = []
    outputs = []
    ...
    def pdf_pages(fnm, zoomin=3):
        ...
        images = [p.to_image(resolution=72 * zoomin).annotated for idx, p in
                  enumerate(pdf.pages)]

        for idx, page in enumerate(images):
            outputs.append(os.path.split(fnm)[-1] + f"_{idx}.jpg")
