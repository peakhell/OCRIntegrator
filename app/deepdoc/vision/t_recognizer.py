...
from app.deepdoc.vision import Recognizer, LayoutRecognizer, TableStructureRecognizer, OCR, init_in_out
import argparse
import re
import numpy as np
...
def main(args):
    ...
    if args.mode.lower() == "layout":
        ...
        detr = Recognizer(labels, "layout", os.path.join(ABS_PATH, "rag/res/deepdoc/"))
